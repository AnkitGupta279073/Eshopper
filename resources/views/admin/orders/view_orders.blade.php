            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    <a target="_blank" href="{{ url('admin/view-order/'.$order->id)}}" class="btn btn-success btn-mini">View Order Details</a> <br>
                    @if($order->order_status == "Shipped" || $order->order_status == "Delivered" || $order->order_status == "Paid")
                    <a target="_blank" href="{{ url('admin/view-order-invoice/'.$order->id)}}" class="btn btn-info btn-mini">View Order Invoice</a> <br>
                    <a target="_blank" href="{{ url('admin/view-pdf-invoice/'.$order->id)}}" class="btn btn-warning btn-mini">View PDF Invoice</a> 
                    @endif
                  </td>
                </tr>
                @endforeach
