						...
						<div class="col-sm-7">
							<form name="addtoCartForm" id="addtoCartForm" action="{{ url('add-cart') }}" method="post">{{ csrf_field() }}
								...
								<div class="product-information"><!--/product-information-->
									...
									<p>Product Sleeve: {{ $productDetails->sleeve }}</p>
									@endif
									@if(!empty($productDetails->pattern))
									<p>Product Pattern: {{ $productDetails->pattern }}</p>
									@endif
									<p>
									...
									<span>
										...
										@if($total_stock>0)
											<button type="submit" class="btn btn-fefault cart" id="cartButton" name="cartButton" value="ShoppingCart">
									...
									<p><button type="submit" class="btn btn-fefault cart" id="wishListButton" name="wishListButton" value="WishList">
									...
									<button type="button" onclick="return checkPincode();">Go</button></p>
